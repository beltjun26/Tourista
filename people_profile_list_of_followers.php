...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="headerprofile">
				...
				<ul id="follows">
					...
					<li><a href="#follow-head">Followers: <?php echo $followerscount['followerscount'];?></a></li>
				</ul>
				<div id="aboutme">
					<h1>ABOUT ME</h1>
					<br>
			...
			<?php } else { ?>
					<ul class="visitor-options">
						<li><a href="people_profile.php?acc_id=<?=$acc_id?>">Feed<span class="glyphicon glyphicon-credit-card"></a></li>
		...
		<div class="search-container">
			<h1 id="follow-head">FOLLOWERS</h1>	
			<div class="search-type">	
				<input type="text" id="Filter" onkeyup="Filter()" placeholder="Filter names...">
				<ul>
					<li><a href="people_profile_list_of_following.php?acc_id=<?=$acc_id?>#follow-head">FOLLOWING</a></li>				
			...
			<?php }
					...
					<p class="no-results-follow">No followers</p>
			<?php } ?>
			</ul>
		</div>
