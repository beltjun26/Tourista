	...
	<body>
		...
		<div id = "navBar">
			...
			<ul id = "navList">
				...
				<li><a href="my_profile.php?=<?=$_SESSION['userID']?>" class="image-list"><img src="images/profile_pic_img/acc_id_<?=$_SESSION['userID']?>.jpg" onerror = "this.src = 'images/default_profile.png'" class="profile"></a></li>
			</ul>
		</div>
